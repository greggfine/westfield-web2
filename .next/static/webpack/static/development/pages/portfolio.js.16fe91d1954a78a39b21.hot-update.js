...
// Module
exports.push([module.i, ".portfolio_Portfolio__websites__2rPvN {\n  list-style-type: none;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: space-around;\n  margin: 60px auto;\n  padding: 40px 0px;\n  font-size: 1.5rem;\n  width: 60%; }\n\n.portfolio_Portfolio__heading__3RS8x {\n  color: #fff;\n  border: 1px solid #000;\n  background-color: #fff; }\n", "",{"version":3,"sources":["portfolio.module.scss"],"names":[],"mappings":"AACE;EACE,qBAAqB;EACrB,aAAa;EACb,eAAe;EACf,6BAA6B;EAC7B,iBAAiB;EACjB,iBAAiB;EACjB,iBAAiB;EACjB,UAAU,EAAA;;AAGZ;EACE,WAAW;EACX,sBAAsB;EACtB,sBAAsB,EAAA","file":"portfolio.module.scss","sourcesContent":[".Portfolio {\n  &__websites {\n    list-style-type: none;\n    display: flex;\n    flex-wrap: wrap;\n    justify-content: space-around;\n    margin: 60px auto;\n    padding: 40px 0px;\n    font-size: 1.5rem;\n    width: 60%;\n  }\n\n  &__heading {\n    color: #fff;\n    border: 1px solid #000;\n    background-color: #fff;\n  }\n}\n"]}]);
// Exports
exports.locals = {
...
//# sourceMappingURL=portfolio.js.16fe91d1954a78a39b21.hot-update.js.map