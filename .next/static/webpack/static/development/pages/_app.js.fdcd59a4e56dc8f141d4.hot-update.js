  ...
  return (// <Navbar expand="lg" className={styles.Nav}>
    ...
    __jsx("header", {
      ...
      onClick: function onClick() {
        var myId = document.getElementById("menu-icon");
        var sideMenu = document.querySelector("#side-menu"); //   const main = document.getElementsByTagName("main")[0];

        myId.classList.toggle("site-header__menu-icon--close-x");
        sideMenu.classList.toggle("open-side-menu"); //   main.classList.toggle("move-main");
      },
      __source: {
        fileName: _jsxFileName,
        lineNumber: 39
...
//# sourceMappingURL=_app.js.fdcd59a4e56dc8f141d4.hot-update.js.map