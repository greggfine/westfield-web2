...
function Navigation() {
  return (// <Navbar expand="lg" className={styles.Nav}>
    //   <div class={styles.Nav__menuIcon} id="menu-icon">
    //     <div class={styles.Nav__menuIcon__middle}></div>
    //   </div>
    //   <Container>
    ...
    // </Navbar>
    __jsx("header", {
      "class": _Navigation_module_scss__WEBPACK_IMPORTED_MODULE_4___default.a.Nav,
      __source: {
      ...
      "class": _Navigation_module_scss__WEBPACK_IMPORTED_MODULE_4___default.a.Nav__menuIcon,
      id: "menu-icon",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 40
      ...
      "class": _Navigation_module_scss__WEBPACK_IMPORTED_MODULE_4___default.a.Nav__menuIcon__middle,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 41
      },
      ...
      "class": "site-header__brand-wrapper",
      __source: {
        fileName: _jsxFileName,
        lineNumber: 53
      },
...
//# sourceMappingURL=_app.js.3c56a78c9aa07a119084.hot-update.js.map